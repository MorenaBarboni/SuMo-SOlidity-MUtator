        ...
        if (node.number % 1 == 0) {
          ...
          if (node.number == 1) {
            ...
            if (sliced === "-") {
              ...
              pushMutation(new Mutation(file, functionName, start, end, startLine, endLine, original, "-2" + subdenomination, "ILR"));
            }
            else {
              pushMutation(new Mutation(file, functionName, start, end, startLine, endLine, original, "0" + subdenomination, "ILR"));
              pushMutation(new Mutation(file, functionName, start, end, startLine, endLine, original, "2" + subdenomination, "ILR"));
            ...
            pushMutation(new Mutation(file, functionName, start, end, startLine, endLine, original, dec + subdenomination, "ILR"));
