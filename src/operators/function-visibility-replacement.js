    ...
    FunctionDefinition: (node) => {
      ...
      //Standard function
        ...
        switch (node.visibility) {
		  ...
		  if(replacement)
         mutations.push(new Mutation(file, node.range[0], node.range[1], replacement))
	    if(replacement2)
         mutations.push(new Mutation(file, node.range[0], node.range[1], replacement2))
	    if(replacement3)
         mutations.push(new Mutation(file, node.range[0], node.range[1], replacement3))
